				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="{{route('panier.panier')}}">Panier</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="total-amount">
						<div class="row">
								...
								<div class="left">
									<div class="coupon">
										<form action="#" target="_blank">
											<input name="Coupon" placeholder="Enter Votre Coupon">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li>Total<span>$330.00</span></li>
										{{-- <li>Shipping<span>Free</span></li>
										<li>You Save<span>$20.00</span></li>
										<li class="last">You Pay<span>$310.00</span></li> --}}
									</ul>
									<div class="button5">
										<a href="{{route('panier.checkout')}}" class="btn">Valider</a>
										<a href="#" class="btn">Continue vos Achats</a>
									</div>
								</div>
							</div>
						</div>
